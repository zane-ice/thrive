...
var body: some View {
    ScrollView(){
    VStack(alignment: .leading, spacing: 10) {
        Text("Exonian Advice").fontWeight(.bold).padding(15)
        Text("1. Use sleep-ins or any time before your first class of the day to finish homework or study for tests. Make sure to go to sleep early the night before so that you will be well rested in the morning. \n 2. Find productive time throughout the day: the second half of lunch, uni-free, department and faculty meeting, etc. \n 3. Studying for tests the night before should not mean learning that entire term’s work in one night. Make sure that you’re staying on top of your work throughout the term (i.e. doing all the math problems every night) so that test day is rest day.").padding(.leading, 15)
        Text("From Meili Gupta, Class of 2020, Phillips Exeter Academy").padding(15)
    }
    }
}
}
