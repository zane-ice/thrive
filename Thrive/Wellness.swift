...
extension Wellness{
    struct meditation: View{
        var body: some View{
            ScrollView{
                Text("Meditation Apps").fontWeight(.bold).font(.body).padding(15)
                Text("\u{2022} Headspace\u{2022} Simple Habit Daily Meditations\u{2022} Calm\u{2022} Oak").font(.body).padding(15)
            }
        }
    }
}
