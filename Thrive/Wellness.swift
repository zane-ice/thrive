    ...
    struct sleep: View{
        var body: some View{
            ScrollView{
                ...
                Text("What is sleep?").bold().foregroundColor(Color.red)
                ...
                VStack(alignment: .leading, spacing: 10) {
                Text("What are the health effects of not getting enough sleep?").bold()
                ...
                Text("How can I get better sleep?").bold()
